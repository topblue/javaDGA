...
//		double v1=0.001,v2=0.0003;
//		System.out.println(algo.div(v1, v2));
...
//		mainClass.queryIdToDelete();
	...
	double features1(String fileName){
		...
		AlgorithmString algo = new AlgorithmString();
		String mergeDomain = "";
		ArrayList<String> list = es.queryStringDomain("dga", "CRIME", fileName);
...
//		System.out.println(mergeDomain);
	 ...
	 * 
	 * **/
	void features2(String fileName){
		DomainStringFormat domainstringformat = new DomainStringFormat();
		AlgorithmString algo = new AlgorithmString();
//		String mergeDomain = "";
...
//			    String key = entry.getKey().toString();
	...
	void features3(String fileName,double mean){
		...
		AlgorithmString algo = new AlgorithmString();
//		String mergeDomain = "";
		double features3_total=0.0,features3_size =0.0;
		ArrayList<String> list = es.queryStringDomain("dga", "CRIME", fileName);
